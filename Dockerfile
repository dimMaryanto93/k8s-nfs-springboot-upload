...
ARG PRIVATE_REGISTRY=docker.io/
FROM ${PRIVATE_REGISTRY}${JDK_VENDOR}:${JDK_VERSION}

LABEL maintener="Dimas Maryanto <software.dimas_m@icloud.com>"
LABEL app.framework.name="spring-boot" app.framework.version="2.5.2" app.sdk.version="${JDK_VERSION}" app.sdk.name="${JDK_VENDOR}"
